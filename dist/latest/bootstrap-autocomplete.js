...
// CONCATENATED MODULE: ./src/resolvers.ts
...
// CONCATENATED MODULE: ./src/dropdownV4.ts
/*
 *	Dropdown class. Manages the dropdown drawing
 */
var DropdownV4 = /** @class */ (function () {
    function DropdownV4(e, formatItemCbk, autoSelect, noResultsText, focusChangeHandler) {
    ...
    DropdownV4.prototype.init = function () {
        ...
        this._dd.on('mouseenter', '.dropdown-item', function (evt) {
            if (_this.haveResults) {
                _this.updateItemFocus($(evt.currentTarget));
     ...
     * @param element
     */
    DropdownV4.prototype.updateItemFocus = function (element) {
...
var main_AutoComplete = /** @class */ (function () {
    ...
    AutoComplete.prototype.init = function () {
        ...
        if (this.getBootstrapVersion()[0] >= 4) {
            // v4
            var me = this;
            var focusChangeHandler = function (data, element) {
                me.handleItemFocusChange(data, element);
            };
            this._dd = new DropdownV4(this._$el, this._settings.formatResult, this._settings.autoSelect, this._settings.noResultsText, focusChangeHandler);
        }
        else {
     ...
     */
    AutoComplete.prototype.handleItemFocusChange = function (item, listElement) {
